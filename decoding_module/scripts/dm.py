...
class MLP(object):
    def __init__(self):
        ...
        # Pub 
        self.pub_perturbation = rospy.Publisher('motorStimulation', Float64, queue_size=1)

        # Sub
        rospy.Subscriber('motorNeuralSignal', Float64MultiArray, self.predict)
        rospy.Subscriber('initiate', String, self.start)
    ...
    def loadMLP(self):        
        self.bias = np.loadtxt(open("/home/jhielson/catkin_ws/src/PhD/decoding_module/scripts/bias.csv", "rb"), delimiter=",", skiprows=0)
        self.weights_input = np.loadtxt(open("/home/jhielson/catkin_ws/src/PhD/decoding_module/scripts/input.csv", "rb"), delimiter=",", skiprows=0)
        self.weights_hidden1 = np.loadtxt(open("/home/jhielson/catkin_ws/src/PhD/decoding_module/scripts/hidden1.csv", "rb"), delimiter=",", skiprows=0)
        self.weights_hidden2 = np.loadtxt(open("/home/jhielson/catkin_ws/src/PhD/decoding_module/scripts/hidden2.csv", "rb"), delimiter=",", skiprows=0)
        self.weights_output = np.loadtxt(open("/home/jhielson/catkin_ws/src/PhD/decoding_module/scripts/output.csv", "rb"), delimiter=",", skiprows=0)

    def testFile(self):
        self.dataH = np.loadtxt(open("/home/jhielson/catkin_ws/src/PhD/decoding_module/scripts/H.csv", "rb"), delimiter=",", skiprows=0)
        self.dataPD = np.loadtxt(open("/home/jhielson/catkin_ws/src/PhD/decoding_module/scripts/PD.csv", "rb"), delimiter=",", skiprows=0)
